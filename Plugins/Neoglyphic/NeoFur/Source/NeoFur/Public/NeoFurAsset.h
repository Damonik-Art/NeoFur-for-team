...
//     Source_Before_Replacements/./NeoFur/Public/NeoFurAsset.h
...
// Note: This file has heavy use of an external preprocessor that uses
// C-preprocessor-like syntax inside of comments. Do not delete
// commented preprocessor directives!
